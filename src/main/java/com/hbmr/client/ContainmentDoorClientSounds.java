...
/** Loops {@code wgh_start} while the QE containment door is opening/closing. */
@OnlyIn(Dist.CLIENT)
public final class ContainmentDoorClientSounds {
	private static LoopingDoorSound moveLoop;
	private static MultiblockControllerBlockEntity active;

	private ContainmentDoorClientSounds() {
	}
